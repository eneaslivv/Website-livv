  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p
            className="text-sm text-[#2c2420]/50 font-mono text-center"
            style={{
              lineHeight: "20px",
            }}
          >
            ...
            {isHovered && (
              <span
                className="inline-block w-[2px] h-[14px] bg-[#b8836e]/60 ml-0.5"
                style={{
        ...
        >
          <div className="relative py-4 px-4">
            <h3 className="font-semibold text-[#2c2420]/60 text-base leading-snug line-clamp-2 min-h-[2.75rem] transition-colors duration-300 group-hover:text-[#2c2420]">
              New Project
            </h3>
          </div>
          <div className="relative h-[48px]">
            <div className="absolute inset-x-0 top-0 h-[1px] border-t border-dashed border-[#2c2420]/[0.06]" />
            <div className="absolute inset-0 flex items-center justify-between px-4">
              <span className="text-[13px] text-[#8a7e74] transition-colors duration-300 group-hover:text-[#2c2420]/60">
                Generate AI Clips
              </span>
            </div>
          </div>
