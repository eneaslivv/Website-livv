...
const accounts = [
  { name: "Payper", icon: "P", color: "#d4734b", country: "Argentina", mrr: "$7,513", vol: "$64,406" },
...
export function HeroBanner() {
  ...
  return (
    <div
      ...
      className="relative w-full overflow-hidden rounded-2xl border border-[#ddd5cc]/50"
      style={{ background: "linear-gradient(145deg, #faf7f4 0%, #f5f0eb 50%, #efe8e0 100%)" }}
    >
      {/* Diagonal lines */}
      <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-60" aria-hidden="true">
        <defs>
          <pattern id="diag" width="32" height="32" patternUnits="userSpaceOnUse" patternTransform="rotate(-45)">
            <line x1="0" y1="0" x2="0" y2="32" stroke="#c9a48a" strokeWidth="0.4" opacity="0.1" />
          </pattern>
        </defs>
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, rgba(184,131,110,0.15) 0%, transparent 65%)", filter: "blur(50px)" }}
        animate={{ scale: [1, 1.06, 1], opacity: [0.7, 1, 0.7] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute -top-16 right-1/4 w-56 h-56 rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(201,164,138,0.12) 0%, transparent 65%)", filter: "blur(40px)" }}
        animate={{ scale: [1, 1.04, 1], x: [0, 6, 0] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 1 }}
      />
      <motion.div
        className="absolute top-1/2 left-[40%] w-40 h-40 rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(160,105,79,0.08) 0%, transparent 60%)", filter: "blur(30px)" }}
        animate={{ y: [0, -8, 0] }}
      ...
      <div className="relative flex flex-col lg:flex-row items-center gap-6 lg:gap-0 px-6 sm:px-8 lg:px-10 py-8 sm:py-10">

        {/* Left: Heading */}
        <motion.div
          className="lg:w-[240px] shrink-0 z-10"
          initial={{ opacity: 0, filter: "blur(10px)", y: 10 }}
          animate={{ opacity: 1, filter: "blur(0px)", y: 0 }}
          transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
        >
          <p className="text-[10px] uppercase tracking-[0.2em] text-[#b8836e] font-medium mb-3">What we build</p>
          <h2 className="text-[clamp(1.3rem,2.5vw,1.75rem)] font-light leading-[1.2] tracking-tight text-[#2c2420]">
            Custom apps,{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b8836e] via-[#c9a48a] to-[#a0694f]">built by agents</span>
          </h2>
          <p className="mt-2.5 text-[11px] leading-relaxed text-[#8a7e74] max-w-[200px]">
            From scope to deploy. AI-driven pipeline, human quality.
          </p>
          <motion.div
          ...
          >
            <button className="px-3 py-1.5 rounded-full text-[11px] font-medium bg-[#1a1714] text-[#f5f0eb] hover:bg-[#2c2420] transition-all duration-200 active:scale-[0.97]">
              Explore
            </button>
            <button className="px-3 py-1.5 rounded-full text-[11px] font-medium text-[#8a7e74] border border-[#ddd5cc] hover:border-[#c9a48a] hover:text-[#2c2420] transition-all duration-200">
              Docs
            </button>
          </motion.div>
        </motion.div>
        ...
        <div className="flex-1 min-w-0 relative" style={{ perspective: "1200px" }}>
          ...
          >
            ...
            >
              ...
              >
                <div className="absolute inset-x-0 top-0 h-[2px] rounded-t-xl bg-gradient-to-r from-[#b8836e] via-[#c9a48a] to-[#a0694f]" />
                ...
                <div className="flex items-center gap-2 mb-2.5">
                  ...
                  <span className="text-[11px] font-semibold text-[#2c2420]">Payper</span>
