      ...
      >
        ...
        <motion.div
          ...
          animate={{
            ...
            backgroundColor: isGenerating ? "#e8ded4" : "#ede7e0",
          }}
          transition={{
            rotateX: {
              type: "spring",
        ...
        <motion.div
          ...
          animate={{
            ...
            backgroundColor: isGenerating ? "rgba(255, 255, 255, 0.9)" : "rgba(255, 255, 255, 0.85)",
          }}
          transition={{
            rotateX: {
              type: "spring",
        ...
        >
          <div className="relative py-4 px-4 min-h-[2.75rem]">
            ...
            />
            <div
              className="relative z-0 transition-all duration-200 min-h-[2.75rem]"
              style={{ opacity: isEditing ? 0 : 1, pointerEvents: isEditing ? "none" : "auto" }}
            >
              <h3
                className={`font-semibold text-[#2c2420]/80 text-base leading-snug line-clamp-1 transition-colors duration-200 ${!isGenerating ? "group-hover:text-[#2c2420]" : ""}`}
              >
                {project.title}
              </h3>
              {project.category && (
                <p className="text-[11px] text-[#b8836e]/80 mt-0.5 tracking-wide">{project.category}</p>
              )}
            </div>
            <textarea
              ref={textareaRef}
              ...
              {isEditing ? (
                ...
                >
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[13px] text-transparent bg-clip-text bg-gradient-to-r from-[#b8836e]/60 via-[#b8836e] to-[#b8836e]/60 bg-[length:200%_100%] animate-shimmer">Generating</span>
                    {progress < 95 && <span className="text-[13px] text-[#8a7e74]">{remainingEta}</span>}
                  </div>
