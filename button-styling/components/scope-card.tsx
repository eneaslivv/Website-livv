...
import { BadgeScroller } from "@/components/badge-scroller"
import { QuotingFlow } from "@/components/quoting-flow"
  ...
  return (
    <div
      style={{
        ...
        height: phase === "quoting" ? "clamp(400px, auto, 460px)" : undefined,
        background: "#ffffff",
        borderRadius: "24px",
    ...
    >
      {phase === "badges" ? (
        ...
        <div style={{ animation: "fadeSlideIn 0.4s ease-out", flex: 1, display: "flex", flexDirection: "column", minHeight: 0 }}>
          <QuotingFlow
            onBack={handleBack}
