...
const ROW_1: BadgeItem[] = [
  ...
  { id: "webflow", label: "Webflow", logo: "/badges/webflow.svg" },
  { id: "shopify", label: "Shopify", logo: "/badges/shopify.svg" },
  { id: "framer", label: "Framer", logo: "/badges/framer.svg" },
...
const ROW_2: BadgeItem[] = [
  { id: "wordpress", label: "WordPress", logo: "/badges/wordpress.png" },
  { id: "ui", label: "User interface" },
  { id: "nextjs", label: "Next.js", logo: "/brands/nextjs.png" },
          ...
          >
            {badge.logo && (
              <Image
                ...
                height={0}
                sizes="100vw"
                style={{ objectFit: "contain", width: "auto", height: "18px" }}
              />
            )}
            {badge.label}
          </button>
