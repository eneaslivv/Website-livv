...
export function LiquidMetalButton({ label = "Get Started", onClick, viewMode = "text", fullWidth = false }: LiquidMetalButtonProps) {
  ...
  const dimensions = useMemo(() => {
    if (viewMode === "icon") {
      ...
      // Calculate width based on label length - increased for more prominence
      const baseWidth = Math.max(160, label.length * 11 + 48)
      return {
        width: baseWidth,
        height: 52,
        ...
        >
          <div
            style={{
              ...
              gap: "6px",
              paddingLeft: fullWidth ? "16px" : "0",
              paddingRight: fullWidth ? "16px" : "0",
              transformStyle: "preserve-3d",
              transition:
            ...
            {viewMode === "text" && (
              <span
                style={{
                  ...
                  maxWidth: fullWidth ? "calc(100% - 20px)" : "auto",
                  paddingLeft: fullWidth ? "10px" : "0",
                  paddingRight: fullWidth ? "10px" : "0",
                }}
              >
                {label}
              </span>
