  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p
            className="text-sm text-white/40 font-mono text-center"
            style={{
              lineHeight: "20px",
            }}
          >
        ...
        >
          <div className="relative py-4 px-4">
            <h3 className="font-semibold text-white/90 text-base leading-snug line-clamp-2 min-h-[2.75rem] transition-colors duration-300 group-hover:text-white">
              Apply to resell
            </h3>
          </div>
          <div className="relative h-[48px]">
            <div className="absolute inset-x-0 top-0 h-[1px] border-t border-white/10" />
            <div className="absolute inset-0 flex items-center justify-between px-4">
              <span className="text-[13px] text-white/60 transition-colors duration-300 group-hover:text-white/80">
