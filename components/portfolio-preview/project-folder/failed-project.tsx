    ...
    >
      ...
      >
        <div className="relative w-[288px] h-fit mb-4">
          <div
            className="relative z-0 rounded-2xl mb-[-48px] h-36 border border-[#c53030]/[0.1]"
            style={{ background: "linear-gradient(180deg, rgba(197,48,48,0.04) 0%, rgba(197,48,48,0.01) 100%)" }}
          >
            <div
              className="absolute inset-0 rounded-2xl"
              style={{ background: "radial-gradient(circle at 50% 60%, rgba(197,48,48,0.05), transparent 70%)" }}
            />
          ...
          >
            <div className="absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#c53030]/[0.1] to-transparent" />
            <div className="py-4 px-4">
              <h3 className="font-medium text-[#2c2420]/50 text-base leading-snug line-clamp-2 min-h-[2.75rem]">
                {project.title}
              </h3>
            </div>
            <div className="relative h-[48px]">
              ...
              <div className="absolute inset-0 flex items-center justify-between px-4 pr-2">
                <span className="text-[13px] text-[#c53030]/70">Processing failed</span>
