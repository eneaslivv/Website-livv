                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <motion.div whileHover={{ y: -5 }} className="group cursor-pointer">
                            <a href="https://www.drinkmedly.com/" target="_blank" rel="noopener noreferrer" className="block">
                                ...
                                <h4 className="font-medium text-[#2c0405] group-hover:text-[#822b2e] transition-colors">DRINK MEDLY</h4>
                                <p className="text-xs text-[#2c0405]/60 mt-2 leading-relaxed max-w-sm">
                                    A clean, mobile-first e-commerce site built around a dynamic bundle/checkout flow and subscription logic, with a minimal, conversion-focused UI that prioritizes clarity, speed, and brand storytelling.
                                </p>
                            </a>
                        </motion.div>
                        <motion.div whileHover={{ y: -5 }} className="group cursor-pointer">
