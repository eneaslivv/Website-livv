...
export const servicePages: Record<string, ServicePageContent> = {
  ...
  "product-strategy-ui": {
    ...
    proof: {
      name: "Frenetic Pace",
      category: "Sports media platform · Web, app & admin",
      challenge: "A sports media brand needed articles, scores, tickets and a store to live on one platform instead of separate tools.",
      contribution: "We designed and built the web, the iOS and Android apps and the admin panel that runs them.",
      href: "/projects/frenetic-pace",
      image: "/images/frenetic-pace/intro-home-en-navegador.webp",
      accent: "#011C3A",
      annotations: ["WEB · IOS · ANDROID", "STATUS: LIVE"],
    },
    cta: {
